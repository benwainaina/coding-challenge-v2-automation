export const IDActionAddTasks = '[Task List Component] add tasks';
...
export const IDActionSetMetadataToBeUsedToPerformAction =
  '[Task List Component] sets the metadata which will be used in deciding the action to be performed on selected tasks';
